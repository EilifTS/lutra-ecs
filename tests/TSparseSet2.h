...
#include <lutra-ecs/SparseSet2.h>
...
TEST(SparseSet2, TestInsertHasGet)
{
	lcs::SparseSet2<TestHandle, u64> set{};
...
TEST(SparseSet2, TestInsertRemoveInsert)
{
	lcs::SparseSet2<TestHandle, u64> set{};
...
TEST(SparseSet2, TestInsertRemoveInsert2)
{
	lcs::SparseSet2<TestHandle, u64> set{};
...
TEST(SparseSet2, TestIterationReverse)
{
	lcs::SparseSet2<TestHandle, u64> set{};
	set.ReserveSparseSize(16);
...
TEST(SparseSet2, TestClearSparse)
{
	lcs::SparseSet2<TestHandle, u64> set{};
	set.ReserveSparseSize(16);
