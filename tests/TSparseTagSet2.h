...
#include <lutra-ecs/SparseTagSet2.h>

using TestHandle = lcs::Handle<uint32_t, 16>;

TEST(SparseTagSet2, InsertHasGet)
{
	lcs::SparseTagSet2<TestHandle> set{};
...
TEST(SparseTagSet2, InsertRemoveInsert)
{
	lcs::SparseTagSet2<TestHandle> set{ };
...
TEST(SparseTagSet2, InsertRemoveInsert2)
{
	lcs::SparseTagSet2<TestHandle> set{ };
...
TEST(SparseTagSet2, ClearSparse)
{
	lcs::SparseTagSet2<TestHandle> set{ };
	set.ReserveSparseSize(16);
